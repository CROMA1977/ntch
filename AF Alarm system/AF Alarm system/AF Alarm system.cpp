...
// AF Alarm system.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CAFAlarmsystemApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CAFAlarmsystemApp 建構

CAFAlarmsystemApp::CAFAlarmsystemApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CAFAlarmsystemApp 物件

CAFAlarmsystemApp theApp;


// CAFAlarmsystemApp 初始化

BOOL CAFAlarmsystemApp::InitInstance()
{
